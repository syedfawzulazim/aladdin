                        ...
                        <div class="col-lg-4 col-md-5 col-sm-4">
                            <div class="single-footer footer-about">
                                ...
                                <div class="footer-brief">
                                    <p> <b>Your Trusted Shopping Destination...</b> </p>
                                    <p> <b>Join Our facebook Group for letest Offers</b></p>
                                </div>
                                <ul class="footer-social">
                                    <li>
                                        <a class="facebook" href="https://www.facebook.com/groups/2429348107390054/" title="Facebook"><i class="zmdi zmdi-facebook"></i></a>
                                        <h4>Email : support@alddin.com.bd</h4>
                                        <h4>Mobile : (+88) 01521237879</h4>
                                    </li>
                                    <!--
                                    <li>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-xs-12">
                            <div class="copyright-text">
                                <p>&copy; <a href="" target="_blank">Aladdin</a> 2019. All Rights Reserved.</p>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xs-12">
