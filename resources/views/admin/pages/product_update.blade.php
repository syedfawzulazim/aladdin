  ...
  <div class="row">
    <div class="col-md-4">
      <div class="card" style="padding:0px 10px;">
        ...
        <div class="card-body">
          <form  action="{{ route('admin.pages.product_edit', $edit->id) }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" name="brand" value="{{ $edit->brand_id }}" required>
            </div>
            <div class="form-group">
