  ...
  <div class="row">
    <div class="col-md-4">
      <div class="card" style="padding:0px 10px;">
        ...
        <div class="card-body">
          <form  action="{{ route('admin.pages.product.product_store') }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="brand" placeholder="Product's Brand" required>
            </div>
            <div class="form-group">
