...
<section class="content container-fluid">
  ...
  <div class="row">
    <div class="col-md-4">
      <div class="card" style="padding:0px 10px;">
        <div class="card-header">
          <h3 style="background-color:#222d32; color:#ffffff; padding: 5px;text-align: center;" ><i class="fas fa-comment-medical"></i> Add Category</h3>
        </div>
        <div class="card-body">
          <form  action="{{ route('admin.pages.category.store') }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            
            <div class="form-group">
              <label for="parent_id"><i class="fas fa-chart-pie"></i> Parent Category</label>
              <select class="form-control" name="parent_id">
                <option value="" selected="">Create Main Category </option>
    ...
    <div class="col-md-8">
      <div class="card" style="padding:0px 10px;">
        <div class="card-header">
          <h3 style="background-color:#222d32; color:#ffffff; padding: 5px;text-align: center;" ><i class="fas fa-database"></i> Category Table</h3>
